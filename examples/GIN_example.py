import torch
from connector.models.gnn import GIN
...
def main():
    ...
    model = GIN(num_features=features.shape[1], hidden_dim=args.hidden_dim, num_classes=num_classes, num_layers=args.num_layers, dropout=args.dropout)
